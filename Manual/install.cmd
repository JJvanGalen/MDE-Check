...
:Signatures
xcopy /E /I /Y "%~dp0CheckMDE-RegistryAddRemove.ps1" %folder%
xcopy /E /I /Y "%~dp0CheckMDE-RegistryRemove.ps1" %folder%
xcopy /E /I /Y "%~dp0install.cmd" %folder%
xcopy /E /I /Y "%~dp0MDE Check.xml" %folder%
xcopy /E /I /Y "%~dp0uninstall.cmd" %folder%
